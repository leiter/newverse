...
suspend fun runBuyerStory1_BrowseAndAddToCart(
    ...
    val loadingState = viewModel.state.value.screens.mainScreen
    ...
    val loadedState = viewModel.state.value.screens.mainScreen
    ...
    availableArticles.take(3).forEachIndexed { index, article ->
        ...
        val afterSelectState = viewModel.state.value.screens.mainScreen
    ...
    itemsToAdd.forEachIndexed { index, (article, quantity) ->
        ...
        val beforeAddState = viewModel.state.value.screens.mainScreen
        ...
        val afterAddState = viewModel.state.value.screens.mainScreen
