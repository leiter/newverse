...
suspend fun runBuyerStory2_ModifyQuantitiesAndFavorites(
    ...
    viewModel.dispatch(BuyMainScreenAction.SelectArticle(testArticle))
    delay(800)
    ...
    quantitySequence.forEachIndexed { index, quantity ->
        ...
        val beforeState = viewModel.state.value.mainScreen
        ...
        val afterState = viewModel.state.value.mainScreen
    ...
    val beforeRemoveState = viewModel.state.value.mainScreen
    ...
    val afterRemoveState = viewModel.state.value.mainScreen
    ...
    val initialFavorites = viewModel.state.value.mainScreen.favouriteArticles
    ...
    articlesToFavorite.forEachIndexed { index, article ->
        ...
        val beforeFavState = viewModel.state.value.mainScreen
        ...
        viewModel.dispatch(BuyMainScreenAction.ToggleFavourite(article.id))
        delay(1200) // Wait for profile update

        val afterFavState = viewModel.state.value.mainScreen
